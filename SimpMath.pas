...
type
    ...
    IVector = interface
        ...
        property Norma: Double read GetNorma write SetNorma;
...
var
    ...
    i: Integer;
begin
    for i := Low(MutVect1) to High(MutVect1) do
        MutVect1[i] := 0;
    for i := Low(MutVect2) to High(MutVect2) do
        MutVect2[i] := 0;
    for i := Low(MutVect3) to High(MutVect3) do
        MutVect3[i] := 0;
