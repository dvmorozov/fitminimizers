...
type
    ...
    TBoundingBoxForm = class(TForm, IUserInteraction)
...
function TBoundingBoxForm.GetInitialAngleStep: Double;
begin
...
procedure TBoundingBoxForm.PostProcessStatistics;
const
    Criterion01 = 0.001;
...
procedure TBoundingBoxForm.DisplayPointCloud(PointCloud: TList);
var
    BoxSizes: TDoubleVector3;
begin
    Memo1.Lines.Add('');
...
procedure TBoundingBoxForm.DisplayInitialAngles(Alpha, Beta, Gamma: Single;
    ShowDetails: Boolean);
var
    Matr: TMatrix;
    Vector: T3Vector;
...
procedure TBoundingBoxForm.DisplayListOfModels(ListOfFiles: TStringList);
var
    i: Integer;
begin
...
function TBoundingBoxForm.GetModelFileName: string;
begin
    Result := ComboBoxFiles.Text;
end;

function TBoundingBoxForm.GetFinalTolerance: Double;
begin
    Result := 0.00001;  // default value
    StrToValue(EditFinalTolerance.Text, Result);
end;

function TBoundingBoxForm.GetEditExitDerivate: Double;
begin
